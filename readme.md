...
Первый семестр — классический ML. Второй — глубокое обучение и проекты.
...
За семестр три большие домашние работы. Все три идут на одних и тех же
данных и складываются в одну историю: достать данные и привести их в порядок,
разложить по темам и собрать честную тестовую выборку, измерить качество
и понять, можно ли верить измерению.

Задачи взяты не из учебника. Это то, чем занимаются в индустрии люди,
которые готовят данные для больших моделей.
...
| III. Данные и качество | 8–11 | кластеризация, текст, калибровка, разметка |
| IV. Нейросети | 12–14 | перцептрон, обратное распространение, устройство проекта |
...
Python 3.11 или новее, менеджер окружений miniconda. Знание питона
